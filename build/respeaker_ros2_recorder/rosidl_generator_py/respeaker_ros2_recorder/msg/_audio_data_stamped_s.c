...
bool respeaker_ros2_recorder__msg__audio_data_stamped__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("respeaker_ros2_recorder.msg._audio_data_stamped.AudioDataStamped", full_classname_dest, 64) == 0);
  }
  respeaker_ros2_recorder__msg__AudioDataStamped * ros_message = _ros_message;
  {  // header
...
PyObject * respeaker_ros2_recorder__msg__audio_data_stamped__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("respeaker_ros2_recorder.msg._audio_data_stamped");
